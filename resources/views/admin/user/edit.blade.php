                            ...
                            <div class="box-body">
                                <div class="col-lg-offset-3 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  value="@if(old('phone')){{old('phone')}}@else{{ $user->phone }}@endif" type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone number">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                @foreach ($roles as $role)
                                                    <div class="col-lg-3">
                                                            <div class="checkbox">
                                                                <label><input name="role[]" type="checkbox" value="{{ $role->id }}"
